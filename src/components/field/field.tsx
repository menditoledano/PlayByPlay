    ...
    return (
      <div class={`field-wrapper ${this.view} ${this.jsonOpen && 'json-open'}`}>
        <div class="field">
          ...
          <pbp-net />
          <svg viewBox="0 0 390 207" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="1" y="14" width="388" height="179" fill="#B0502D" stroke="#FFF" stroke-width="2"/>
            <rect x="301" y="14" width="88" height="179" fill="#B0502D" stroke="#FFF" stroke-width="2"/>
            <rect x="1" y="14" width="88" height="179" fill="#B0502D" stroke="#FFF" stroke-width="2"/>
