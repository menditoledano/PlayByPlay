...
export class lastPointsStat {
  ...
  render() {
    ...
    <div>  
      ...
      <img src="https://res.cloudinary.com/dezalma3v/image/upload/v1548698782/small-rectangle-stat.png"class=" d-none d-sm-block small-stat-rectangle ace"></img>
      ...
      <img src="https://res.cloudinary.com/dezalma3v/image/upload/v1548698782/small-rectangle-stat.png"class=" d-none d-sm-block small-stat-rectangle breakPoint"></img>
