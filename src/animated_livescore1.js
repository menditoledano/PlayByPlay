      ...
      (function (cjs, an) {
        ...
        var img = {};
        lib.ssMetadata = [{
          name: "animated_livescore1_atlas_",
          frames: [
            [0, 0, 110, 56],
            [0, 58, 23, 23]
          ]
        ...
        (lib.Scene_1_onCourt = function (mode, startPosition, loop) {
          ...
          this.timeline.addTween(cjs.Tween.get(this.instance).wait(37).to({
            _off: false
          }, 0).wait(5));
        ...
        (lib.Scene_1_ballMC12 = function (mode, startPosition, loop) {
          ...
          this.timeline.addTween(cjs.Tween.get(this.instance).wait(33).to({
            alpha: 1
          }, 0).wait(3).to({
            alpha: 0.9297
          }, 0).wait(6));
        ...
        (lib.Scene_1_ballMC7 = function (mode, startPosition, loop) {
          ...
          this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({
            alpha: 1
          }, 0).wait(3).to({
            alpha: 0.9297
          }, 0).wait(3).to({
        ...
        lib.properties = {
          ...
          opacity: 1.00,
          manifest: [{
            src: "https://res.cloudinary.com/dezalma3v/image/upload/v1548836237/animated_livescore1_atlas_.png",
            id: "animated_livescore1_atlas_"
          }],
          preloads: []
        };
